        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-lg p-6 border border-gray-100 relative">
              ...
              <div className="pt-4">
                <p className="text-gray-600 italic mb-4">"Bakpia dari Toko Lezat selalu menjadi oleh-oleh wajib setiap kali saya berkunjung ke Magelang. Rasanya tidak pernah mengecewakan!"</p>
            ...
            <div className="bg-white rounded-lg p-6 border border-gray-100 relative">
              ...
              <div className="pt-4">
                <p className="text-gray-600 italic mb-4">"Getuk dari Toko Lezat memiliki tekstur yang sempurna dan rasa yang otentik. Keluarga saya sangat menyukainya."</p>
            ...
            <div className="bg-white rounded-lg p-6 border border-gray-100 relative">
              ...
              <div className="pt-4">
                <p className="text-gray-600 italic mb-4">"Saya selalu puas dengan kualitas produk dari Toko Lezat. Layanan pengiriman juga cepat dan produk dikemas dengan baik."</p>
